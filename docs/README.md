...
| 9 | [Test/MVP Runbook](./09-Test-MVP-Runbook.md) | แนวทางติดตั้ง/ทดสอบเว็บทดสอบ |
...
## ✅ Test/MVP Scope (สำหรับเว็บทดสอบ)

### เป้าหมาย
ทำให้ระบบ “ทดสอบได้จริง” ด้วยฟีเจอร์หลักที่จำเป็นที่สุดเท่านั้น

### In Scope (ทำแน่)
- สมัคร/เข้าสู่ระบบด้วยอีเมล
- ดูรายการสินค้า + รายละเอียดสินค้า
- เพิ่มสินค้าในตะกร้า / แก้จำนวน / ลบ
...
- Coupon/Promotion
- Multi-seller (ให้มีร้านเดียวก่อน)
- ระบบ Admin Dashboard เต็มรูปแบบ

### แนวทาง Backend ที่ใช้
- ใช้ `Next.js API Routes` สำหรับเว็บทดสอบ (โค้ดอยู่ที่เดียว)
...
## 🧪 Test Data & Seed (แนะนำ)
- สร้างผู้ใช้ตัวอย่าง 2-3 คน
- สร้างสินค้า 20-50 รายการ
- สร้างคำสั่งซื้อ 5-10 รายการ
- สร้างรีวิว 10 รายการ

---

## ✅ Smoke Test Checklist
- สมัคร/เข้าสู่ระบบได้
- โหลดหน้า `/products` ได้
- เพิ่มสินค้าเข้าตะกร้าได้
- Checkout แบบทดสอบได้
- ดูรายการคำสั่งซื้อของตัวเองได้
